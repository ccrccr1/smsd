...
public String toString() {
	return "MemberDTO [m_id=" + m_id + ", m_name=" + m_name + ", m_email=" + m_email + ", m_grade=" + m_grade
			...
			+ ", m_phone3=" + m_phone3 + " m_addr1=" + m_addr1
			+ ", m_addr2=" + m_addr2 + ", m_addr3=" + m_addr3 + ", m_birth=" + m_birth + ", m_birth1=" + m_birth1
			+ ", m_birth2=" + m_birth2 + ", m_birth3=" + m_birth3 + ", m_date=" + m_date + ", m_money=" + m_money + "]";
}
public MemberDTO() {
	super();
