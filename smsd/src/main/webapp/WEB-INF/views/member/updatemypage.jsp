									...
									<div class="form-wrap __phone">
										...
										<div class="ui-input">
											<input type="tel" id="cellphoneNo2" name="m_phone1"
												value="${dto.m_phone1 }" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"  maxlength="3" title="전화번호 가운데 자리"> 
										</div>
										<div class="ui-input">
											<input type="tel" id="cellphoneNo2" name="m_phone2"
												value="${dto.m_phone2}" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="4" title="전화번호 가운데 자리"> 
										</div>
										<div class="ui-input">
											<input type="tel" id="cellphoneNo3" name="m_phone3"
												value="${dto.m_phone3}"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="4" title="전화번호 뒷자리">
										</div>
									</div>
								</div>
							</div>
